...
,   doesNotExist: new(Error)("Nothing exists at this path.")
  ...
  var compileModule = function (source, path, defines) {
    ...
    //       explicit return statement in the document.
